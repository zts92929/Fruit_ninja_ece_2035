...
void draw_bomb(boundingBox b)
{
    ...
    uLCD.filled_circle(b.topLeft.x+((b.bottomRight.x-b.topLeft.x)/2),b.topLeft.y+((b.bottomRight.y-b.topLeft.y)/2),(b.bottomRight.y-b.topLeft.y)/2,RED);
    uLCD.filled_rectangle(b.topLeft.x+((b.bottomRight.x-b.topLeft.x)/2)-1, b.topLeft.y+6, b.topLeft.x+((b.bottomRight.x-b.topLeft.x)/2)+1, b.topLeft.y, WHITE);
...
void draw_trash(boundingBox b)
{
    uLCD.filled_rectangle(b.topLeft.x, b.topLeft.y, b.bottomRight.x, b.bottomRight.y, GREEN);
}

void draw_strike(boundingBox b)
{
    uLCD.filled_rectangle(b.topLeft.x, b.topLeft.y, b.bottomRight.x, b.bottomRight.y, WHITE);
}